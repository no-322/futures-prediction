...
- Excluded (length mismatch / non-binary): `exp_regime_binary`, `walkforward_wf_baseline_alwaysup`, `walkforward_wf_v1_gbm`, `walkforward_wf_v1_logistic`, `walkforward_wf_v1_rf`, `walkforward_wf_v1rel_gbm`, `walkforward_wf_v1rel_logistic`, `walkforward_wf_v1rel_rf`, `walkforward_wf_v2_gbm`, `walkforward_wf_v2_logistic`, `walkforward_wf_v2_rf`, `walkforward_wf_v3_gbm`, `walkforward_wf_v3_logistic`, `walkforward_wf_v3_rf`.
